...
func main() {
	// Given data
	x := [][]float64{
		{10, 8, 13, 9, 11, 14, 6, 4, 12, 7, 5},       // First predictor variable
		{20, 18, 23, 19, 21, 24, 16, 14, 22, 17, 15}, // Second predictor variable
	}
	y := [][]float64{
		{8.04, 6.95, 7.58, 8.81, 8.33, 9.96, 7.24, 4.26, 10.84, 4.82, 5.68}, // First response variable
		{9.14, 8.14, 8.74, 8.77, 9.26, 8.1, 6.13, 3.1, 9.13, 7.26, 4.74},    // Second response variable
	}
